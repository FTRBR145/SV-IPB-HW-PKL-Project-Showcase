...
import {
  LayoutDashboard, FolderKanban, Users, User, GraduationCap, BookOpen,
      ...
      <div className="flex-1 md:ml-56 flex flex-col min-w-0">
        ...
        <header className="sticky top-0 z-30 h-14 bg-white border-b border-gray-200 px-4 sm:px-6 flex items-center justify-between shadow-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 cursor-pointer px-2 py-1 rounded-xl hover:bg-gray-50 transition-colors border border-gray-200/80">

...
export default function ProjectShowcase({
  ...
  return (
    <section ref={sectionRef} id="projects" className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          className={`flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 scroll-reveal reveal-delay-3 ${headingVisible ? 'is-visible' : ''}`}
        >
        ...
        {/* Projects Grid */}
        {projects.length > 0 ? (
          <div className={`motion-list grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 ${isVisible ? 'is-visible' : ''}`}>
